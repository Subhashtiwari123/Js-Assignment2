/*3.Imagine you are given a list of student objects, each containing the student's name and their marks1 Your
task is to create a function that checks results by filtering out students whose score is more than 9y and
-rints a message saying, "Congratulations [Student Name]! You have cleared the exam."*/
const students = [
    {
      name: "Mithun",
      marks: 95,
